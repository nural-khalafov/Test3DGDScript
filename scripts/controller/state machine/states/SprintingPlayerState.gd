...
func update(delta):
	...
	player_controller.state_machine_playback.travel("SprintBlendSpace1D")
	player_controller.animation_tree.set("parameters/SprintBlendSpace1D/blend_position", SPEED)
